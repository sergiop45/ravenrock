  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "contato@ravenrock.com.br",
      link: "mailto:contato@ravenrock.com.br"
    },
    {
      icon: <Phone className="h-6 w-6 text-primary-600" />,
      title: "Telefone",
      content: "(41) 99278-4730",
      link: "tel:+5541992784730"
    },
    {
      icon: <MapPin className="h-6 w-6 text-primary-600" />,
      title: "Endereço",
      content: "Av. Brasília, 6759 - Novo Mundo, Curitiba - PR",
      link: "#"
    }
  ];
